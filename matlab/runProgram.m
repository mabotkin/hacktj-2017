function [ outfilename ] = runProgram( imagePath, USE_PRECOMPUTATION, optRange )
%RUNPROGRAM Summary of this function goes here
...
outfilename = sprintf('output/CONTRAST_%f_Err_%1.5f-dB.png',CONTRAST,PSNR);
imwrite(REC, outfilename, 'png');
